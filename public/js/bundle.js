      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)(_context.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteDog.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteDog = void 0;
...
var deleteDog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dogId) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Doggy added successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe('pk_test_51KxXkFDpSxXDL5wYuSOFEVD6nJ5Xwf8RhYKIZEhiI4SLKCBjqOGwxr88o8xYSwVcSySVhLuvBDTjsV6RFfEfygZV00dqgIFMmZ');

var bookDog = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(dogId) {
    var session;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(dogId));

          case 3:
            session = _context.sent;
            console.log(session); // 2) Create checkout form + charging credit card
  ...
  return function bookDog(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.bookDog = bookDog;
...
var _deleteDog = require("./deleteDog");

var _newDog = require("./newDog");
...
var deleteBtn = document.getElementById('delete-dog');
var newDogForm = document.querySelector('.form--newDog');
var bookBtn = document.getElementById('book-dog'); // Delegation
